...
include '../Conexion_BD/Conexion.php';
   ...
   if (isset($_POST['enviar'])) {
    ...
    $consulta =$conexion->query ( "SELECT C.No_Consulta, DP.No_Paciente, DP.Nombre, DP.Apellido_Paterno, DP.Apellido_Materno, Hora_inicio, Hora_end, DP.Sexo, Fecha, DP.CURP 
        FROM `consultas` C 
